...
import { ActiveContext, Show_DivContext, Showcontext } from '../pages/Home';
...
export default function Settings() {
  ...
  return (
    <div className='flex   xs:w-[300px]    xs:gap-1 
     justify-between 
    gap-[50px] xs:p-0 p-[20px] '>
        <div className=' relative pl-[150px]    xs:pl-0  p-[10px]'>
            {
              active === 0 ? 
              <Portofoilo/>
              :
          ...
          <div
            ...
            items-center z-50 "
            >
              <div className=" absolute xs:w-[330px] xs:left-[-15px]
              shadow shadow-gray-400 border
               bg-white rounded-2xl top-[10%] ">
                 <TbXboxXFilled
                         onClick={()=>{
                           setShow(false)
                           setShow_Div(0)
                          ...
                          duration-300
                         top-[-40px] xs:right-[-20px] xs:top-[-55px]  right-[-40px]
                          cursor-pointer' />
                    {
                      show_Div === 0 ?
                      <Cancel_Boket/>
        ...
        items-center shadow-lg shadow-gray-300 bg-white
         rounded-2xl gap-[10px] xs:w-[70px] xs:p-2    p-[10px]'>
            <div className='flex xs:self-center self-start
             items-center xs:flex-col gap-2'>
                ...
                <div className='flex flex-col xs:hidden'>
                    ...
                    <p className='text-sm text-[#535763]  xs:text-xs font-semibold'>shahdelmnyar@gmail.com</p>
                </div>
            </div>
            <div
            onClick={()=>{
            ...
            w-full justify-end p-[10px]
             rounded-xl xs:justify-center gap-[10px] cursor-pointer 
              items-center ${active === 0 ? 'text-white bg-[#7367F0] ' : 'text-[#374957]'}`}>
            ...
            w-full justify-end p-[10px]
             rounded-xl xs:justify-center gap-[10px] cursor-pointer 
              items-center ${active === 1 ? 'text-white bg-[#7367F0] ' : 'text-[#374957]'}`}>
            ...
            <div 
            className={`flex  border border-gray-200
            w-full xs:justify-center justify-between p-[10px] text-[#374957]
            ...
            className={`flex  border border-gray-200
            w-full justify-end xs:justify-center p-[10px]
             rounded-xl gap-[10px] cursor-pointer 
              items-center ${active === 2 ? 'text-white bg-[#7367F0] ' : 'text-[#374957]'}`}>
            ...
            className={`flex  border border-gray-200
            w-full justify-end p-[10px] xs:justify-center
             rounded-xl gap-[10px] cursor-pointer 
              items-center ${active === 3 ? 'text-white bg-[#7367F0] ' : 'text-[#FF1212]'}`}>
            ...
            w-full  justify-end p-[10px] text-[#374957]
              gap-[10px] 
              items-center`}>
            ...
            w-full text-[#374957] justify-center
             p-[10px] bg-[#F0F0F0]
             rounded-xl gap-[10px] 
              items-center`}>
                  <div
            className={`flex 
             ...
             rounded-xl gap-[10px] 
              items-center`}>
               ...
               <div
            className={`flex 
             justify-center h-[32px]
             p-[5px] xs:w-fit w-[140px] bg-white
             rounded-2xl gap-[10px] 
              items-center`}>
